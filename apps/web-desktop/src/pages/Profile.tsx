  ...
  return (
    <div className="inner-page profile-page">
      ...
      <div className="content-wrap profile-layout">
        <aside className="profile-nav"><p className="aside-label">我的山居</p><a className="active">命盘总览</a><Link to="/qian">我的签文</Link><Link to="/wishes">我的愿望</Link><Link to="/chat">问室记录</Link><Link to="/palm">手相观照</Link></aside>
        <section>
