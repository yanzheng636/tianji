  ...
  return (
    <div className="premium-home">
      <section className="premium-hero" aria-labelledby="premium-home-title">
        <img className="premium-hero-image" src="/images/temple-hero-premium.webp" alt="暮色中的山间寺院，石阶通向亮着灯的主殿" />
        <div className="premium-hero-shade" />
        <div className="premium-hero-grain" />

        <div className="premium-hero-copy">
          <p className="museum-label"><span>山问 · 东方心事所</span><i />丙午年</p>
        ...
        <div className="temple-map" aria-label="寺院场景入口">
          <Link to="/library" className="map-marker marker-library"><i /><span><small>古籍可考</small>书阁</span></Link>
          <Link to="/chat" className="map-marker marker-chat"><i /><span><small>有惑可问</small>问室</span></Link>
          <Link to="/incense" className="map-marker marker-incense"><i /><span><small>静坐片刻</small>静室</span></Link>
        </div>
        ...
        <div className="premium-hero-foot">
          <span>SHANWEN · 东方心事所</span>
          <a href="#today-practice">向下入山 <i>↓</i></a>
      ...
      <section className="source-section">
        ...
        <div className="source-copy"><p className="museum-label dark"><span>不是答案，是照见</span><i />TEXTUAL EVIDENCE</p><h2>借古人的文字，<br />看清此刻的心。</h2><p>山问收录真实古籍文本。每次解读都尽可能回到原文，让你知道一句话从哪里来，也保留自己判断的空间。</p><Link to="/library">走进书阁 <span>→</span></Link></div>
      </section>
    </div>
  );
}
